"""
FastAPI application for BoiledEgg microservice
"""
...
from boiledegg_handler import BoiledEggHandler

app = FastAPI(
    title="BoiledEgg Microservice",
    description="Molecular property prediction service using BoiledEgg models",
    version="0.1.0"
)
